...
async def fetch_feed(
    ...
    try:
            ...
            if response.status == 200:
                ...
                if feed.bozo and failure_logger:
                    ...
                    failure_logger.log_parse_failure(
                        ...
                        details={
                            "bozo": True,
                            "exception_type": type(bozo_exception).__name__
                            if bozo_exception
                            else None,
                        },
                    )
        ...
        if failure_logger:
            failure_logger.log_network_timeout(url=url, operation="fetch_feed")
...
async def fetch_all_feeds(
    ...
    """Fetch all RSS feeds from a list of source URLs concurrently.
